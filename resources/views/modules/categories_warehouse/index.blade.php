                    ...
                    <div class="card">
                        <div class="pb-0 card-header">
                            <div class="row">
                                <div class="col-6">
                                    @role('administrador')
                                        <h5 class="">Administración de Categorías de bodega</h5>
                                        <p class="mb-0 text-sm">Aquí puedes gestionar las categorías de bodega.</p>
                                    @else
                                        <h5 class="">Categorías de bodega</h5>
                                        <p class="mb-0 text-sm">Aquí puedes visualizar las categorías de bodega.</p>
                                    @endrole
                                </div>
                                @role('administrador')
                                ...
                                <div class="d-flex flex-row justify-content-start">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                            <a class="dropdown-item" href="{{ route('categories_warehouse.pdf') }}"
                                                id="excel">PDF</a>
                                            <a class="dropdown-item"
                                                href="{{ route('categories_warehouse.download-excel') }}"
                                                id="xls">Excel</a>
                                        </div>
                                    </div>
                                </div>
