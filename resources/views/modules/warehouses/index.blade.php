                            ...
                            <div class="row">
                                <div class="col-6">
                                    @role('administrador')
                                        ...
                                        <p class="mb-0 text-sm">Aquí puedes gestionar los bodegas.</p>
                                    @else
                                        <h5 class="">Bodegas</h5>
                                        <p class="mb-0 text-sm">Aquí puedes visualizar los bodegas.</p>
                                    @endrole
                                </div>
                                @role('administrador')
                            ...
                            <table id="warehouses-table"
                                ...
                                <tbody>
                                    @foreach ($warehouses as $warehouse)
                                        <tr id="warehouse_ids{{ $warehouse->id_ware }}"
                                            ...
                                            @role('administrador')
                                                <td class="tw-w-4 tw-p-4">
                                                    <div class="tw-flex tw-items-center">
                                                        <input type="checkbox" value="{{ $warehouse->id_ware }}"
