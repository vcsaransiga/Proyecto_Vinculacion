                        ...
                        <div class="col-xl-4 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent text-center">
                                    <h3 class="font-weight-black text-dark display-6" style="color:#4a59a4!important;">Bienvenido de Nuevo</h3>
                                    <p class="mb-0" style=color:#4a59a4!important;">Crea una nueva cuenta<br></p>
                                    <p class="mb-0" style="color:#4a59a4!important;">O inicia sesion con tus credenciales</p>
                                </div>
                                    ...
                                    <form role="form" class="text-start" method="POST" action="sign-in">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <a href="{{ route('password.request') }}"
                                                class="text-xs font-weight-bold ms-auto" style="color:#4a59a4!important;" >Olvide mi contraseña</a>
                                        </div>
                                        <div class="text-center">
