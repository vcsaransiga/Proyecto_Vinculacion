<aside class="  sidenav navbar max-height-vh-100 navbar-vertical h-100 navbar-expand-xs border-0 bg-slate-900 fixed-start "
    id="sidenav-main">
    <div class="sidenav-header" style="margin-bottom:60px;">
        <img src="../assets/img/logoDash.png" alt="logo" style="height:150px;">
    </div>
    <div class="collapse navbar-collapse max-height-vh-100 px-4 overflow-hidden h-100 w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                    ...
                    <div
                        ...
                        <g id="book-icon" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="open-book" transform="translate(12.000000, 15.000000)" fill="#FFFFFF">
                                <path class="color-background"
                                    d="M0,0 L24,0 C24,8 12,8 12,16 C12,8 0,8 0,0 Z"
                                    id="Path" fill-rule="nonzero"></path>
                                <path class="color-foreground"
                                    d="M0,18 L24,18 C24,10 12,10 12,2 C12,10 0,10 0,18 Z"
                                    id="Shape"></path>
                            </g>
                        </g>
                    </svg>
