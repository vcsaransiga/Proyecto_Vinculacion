<aside class="overflow-hidden sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start "
    ...
    <div class="sidenav-header" style="margin-bottom:60px;">
        <a href="{{ route('dashboard') }}"><img src="../assets/img/logoDash.png" alt="logo" style="height:150px;"></a>
    </div>
    <div class="collapse navbar-collapse px-4 overflow-hidden  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
                            ...
                            <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                                ...
                                <g id="info" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="folder" transform="translate(12.000000, 15.000000)" fill="#FFFFFF">
                                        <path class="color-foreground"
                                            d="M3,0 C1.343145,0 0,1.343145 0,3 L0,15 C0,16.6569 1.343145,18 3,18 L21,18 C22.6569,18 24,16.6569 24,15 L24,6 C24,4.343145 22.6569,3 21,3 L10,3 L8,1 L3,1 C1.343145,1 0,2.343145 0,4 L0,3 Z"
                                            id="Path"></path>
                                    </g>
                                </g>
                            </svg>
            ...
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('about') ? 'active' : '' }} " href="{{ route('about') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <g id="book-icon" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="open-book" transform="translate(12.000000, 15.000000)" fill="#FFFFFF">
                                    <path class="color-background" d="M0,0 L24,0 C24,8 12,8 12,16 C12,8 0,8 0,0 Z"
                                        id="Path" fill-rule="nonzero"></path>
                                    <path class="color-foreground"
                                        d="M0,18 L24,18 C24,10 12,10 12,2 C12,10 0,10 0,18 Z" id="Shape"></path>
                                </g>
                            </g>
                        </svg>

                    </div>
                    <span class="nav-link-text ms-1">Sobre Nosotros</span>
                </a>
            </li>
            {{-- <li class="nav-item">
